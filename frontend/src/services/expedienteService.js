...
export const authorizeUser = (expedienteId, email) =>
  api.post(`/expedientes/${expedienteId}/authorize`, { email });

export const deauthorizeUser = (expedienteId, userId) =>
  api.delete(`/expedientes/${expedienteId}/authorize/${userId}`);
